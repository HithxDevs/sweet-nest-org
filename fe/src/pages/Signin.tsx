        ...
        <div className="flex flex-col lg:flex-row min-h-screen bg-gray-50">
            ...
            <div className="relative bg-gradient-to-br from-purple-600 via-blue-600 to-indigo-800 text-white flex items-center justify-center lg:w-3/5 h-64 lg:h-screen overflow-hidden">
                ...
                <div className="absolute inset-0">
                    <div className="absolute top-20 left-20 w-32 h-32 bg-white bg-opacity-5 rounded-full"></div>
                    <div className="absolute bottom-32 right-40 w-40 h-40 bg-white bg-opacity-5 rounded-full"></div>
                </div>
                
                {/* Content */}
                <div className="relative z-10 text-center px-6 lg:px-12">
                    <div className="mb-6">
                        <Sparkles className="w-12 h-12 lg:w-16 lg:h-16 mx-auto mb-4 text-yellow-300" />
                    </div>
                    <h2 className="text-3xl lg:text-5xl font-bold mb-4 lg:mb-6 bg-gradient-to-r from-white to-blue-200 bg-clip-text text-transparent">
                        Welcome Back
                    </h2>
                    <p className="text-lg lg:text-xl text-blue-100 leading-relaxed max-w-md mx-auto">
                        Step into your digital sanctuary where innovation meets elegance
                    </p>
                </div>
            </div>
                ...
                <div className="bg-white rounded-3xl shadow-2xl p-6 sm:p-8 lg:p-10 w-full max-w-md transform hover:scale-105 transition-all duration-300 border border-gray-100">
                    ...
                    <div className="space-y-4 sm:space-y-6">
                        ...
                        <button
                            ...
                            className="w-full bg-gradient-to-r from-purple-600 to-blue-600 text-white py-2.5 sm:py-3 rounded-xl font-semibold shadow-lg hover:shadow-xl transition-all duration-300 relative overflow-hidden text-sm sm:text-base"
                        >
                            <span className="relative z-10">Sign In</span>
                            <div className={`absolute inset-0 bg-gradient-to-r from-blue-600 to-purple-600 transition-opacity duration-300 ${isHovered ? 'opacity-100' : 'opacity-0'}`}></div>
                        </button>

                        {/* Divider */}
                        <div className="relative flex items-center justify-center my-4 sm:my-6">
                            <div className="border-t border-gray-200 w-full"></div>
                            <span className="bg-white px-4 text-gray-500 text-xs sm:text-sm">or</span>
                        </div>

                        {/* Social Login */}
                        <div className="grid grid-cols-2 gap-3">
                            <button className="flex items-center justify-center py-2.5 sm:py-3 px-3 sm:px-4 border-2 border-gray-200 rounded-xl hover:border-purple-300 hover:bg-purple-50 transition-all duration-300 group">
                                <div className="w-4 h-4 sm:w-5 sm:h-5 bg-gradient-to-r from-blue-500 to-blue-600 rounded-full mr-2"></div>
                                <span className="text-gray-600 font-medium text-xs sm:text-sm">Google</span>
                            </button>
                            <button className="flex items-center justify-center py-2.5 sm:py-3 px-3 sm:px-4 border-2 border-gray-200 rounded-xl hover:border-purple-300 hover:bg-purple-50 transition-all duration-300 group">
                                <div className="w-4 h-4 sm:w-5 sm:h-5 bg-gradient-to-r from-gray-800 to-gray-900 rounded-full mr-2"></div>
                                <span className="text-gray-600 font-medium text-xs sm:text-sm">GitHub</span>
                            </button>
                        </div>
